...
Thay đổi: điều chỉnh thể tích má/cằm/mũi, tỷ lệ mắt, tóc tối màu có biến dạng nhẹ, vật liệu da/mắt/tóc, áo indigo và cổ áo có viền; thêm hoạt cảnh quay đầu, chớp mắt và miệng. Giữ nguyên nguồn VRM trong software/pi/app_ui/models. Mesh, textures và bộ xương nền là tài sản phái sinh pixiv, không nhận là nhân vật gốc tự dựng hoàn toàn.
...
- VERIFIED: Blender xuất nguồn và GLB; 25.207 đỉnh, 154 xương, 57 shape keys khuôn mặt; render hai góc nhìn. GLB mở và render trong trình duyệt PC.
...
GLB dùng vật liệu PBR; ánh sáng và tán xạ da có thể khác cảnh Blender. GLB không mang bộ điều khiển VRM gốc nên không thay trực tiếp file VRM trong loader hiện tại. Bước tiếp theo: duyệt/chỉnh hình khối và tỷ lệ khuôn mặt theo concept 1 trước khi tích hợp lên Pi.
