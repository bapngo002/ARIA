...
| File | Nội dung |
|---|---|
| `ARIA-MASTER-HANDOFF.md` | CURRENT/CANONICAL tiến độ, bootstrap, evidence, pinmap, gaps và next steps |
| `ARIA-BOM-001.md` | Inventory và CAD canonical |
...
| `ARIA-WIRING-001.md` | Quy tắc đấu dây và an toàn |
